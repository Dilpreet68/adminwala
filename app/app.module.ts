...
@NgModule({
    ...
    declarations: [
        AppComponent, ShowUserComponent, AddProductComponent, GetAllMerchantComponent, ShowProductComponent, ShowDiscountComponent, AddDiscountComponent, ShowPromocodeComponent, AddMerchantComponent , Admin],
    providers: [ ],
